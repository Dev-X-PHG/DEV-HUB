    ...
    while task.wait(0.1) do
        if FarmMode == "Farm Katakuri" and getgenv().AutoFarm and World3 then
            pcall(function()
                ...
                if game.ReplicatedStorage:FindFirstChild("Cake Prince") or cakePrince then
                    if cakePrince then
                        local distance = (playerRoot.Position - cakePrince.HumanoidRootPart.Position).Magnitude
                        ...
                        if game:GetService("Workspace").Map.CakeLoaf.BigMirror.Other.Transparency == 0 
                            ...
                            - playerRoot.Position).Magnitude >= 2000 then                            
                            topos(CFrame.new(-2151.82153, 149.315704, -12404.9053))
                        end
                    end
                else
...
spawn(function()
    pcall(function()
        while wait(0.1) do
            if getgenv().AutoTrialRace and World3 then
                local player = game:GetService("Players").LocalPlayer
                ...
                elseif race == "Skypiea" then
                    ...
                    if humanoidRootPart and (finishPart.Position - humanoidRootPart.Position).Magnitude <= 2000 then
                        topos(finishPart.CFrame)
                    end
                elseif race == "Fishman" then
                    ...
                    if seaBeast then
                        ...
                        if rootPart then
                            topos(rootPart.CFrame * CFrame.new(PosX, PosY, PosZ))                            
                            ...
                            local function attack()
                                local keys = {122, 120, 99}
                                for _, key in ipairs(keys) do
                                    game:GetService("VirtualInputManager"):SendKeyEvent(true, key, false, humanoidRootPart)
                                    wait(0.1)
                                    game:GetService("VirtualInputManager"):SendKeyEvent(false, key, false, humanoidRootPart)
                                    wait(0.1)
                                end
                            end
